...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { text: 'Project scheduling & dispatching', included: true },
      { text: 'Invoice creation & tracking', included: true },
      { text: 'Price book management', included: true },
      { text: 'Property/structure tracking', included: true },
      { text: 'Project history logs', included: true },
  ...
  },
  {
    ...
    features: [
      { text: 'Crew management & permissions', included: true },
      { text: 'Crew messaging system', included: true },
      ...
      { text: 'Multi-crew member support', included: true },
    ],
  },
  {
    id: 'max',
    ...
    features: [
      ...
      { text: 'Custom project settings', included: true },
